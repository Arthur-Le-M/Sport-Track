...
<body>
    ...
    ?>
        ...
        <p class='rgpdP'>Le CGU (Conditions Générales d'Utilisation) sont un ensemble de règles et de dispositions qui régissent l'utilisation d'un site web, d'une application mobile ou de tout autre service en ligne. Ces conditions définissent les droits et les obligations des utilisateurs et des propriétaires du site ou du service. Les conditions générales d'utilisation peuvent inclure des clauses sur la confidentialité des données, les règles de comportement en ligne, la propriété intellectuelle, les garanties et les limitations de responsabilité. Elles peuvent également aborder des questions liées à la résiliation du service, aux modifications des termes et aux litiges éventuels. Il est important de lire attentivement les conditions générales d'utilisation avant d'utiliser un site ou un service en ligne.</p>
